...
namespace tools_2D
{
    class point
    {
         ...
         * The copy constructor only copies coordinate and will generate a new
         * ID for new point.
         *
         ...
         * The new point will take the old point's ID and the old one will not
         * be usable anymore(moved).
         *
         ...
         * @return true If this->x < other.x, if x are equal, check if this->y <
         * other.y.
         * @return false
         */
        bool operator<(const point& other) const;

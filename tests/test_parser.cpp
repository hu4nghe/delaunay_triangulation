...
TEST_CASE("CSV parser supports optional header and whitespace delimiter", "[csv]")
{
...
TEST_CASE("CSV parser returns empty vector for empty file", "[csv]")
{
...
TEST_CASE("CSV parser throws filesystem_error for missing file", "[csv]")
{
    REQUIRE_THROWS_AS(read_csv_coords("definitely_missing_file.csv"), std::filesystem::filesystem_error);
}
